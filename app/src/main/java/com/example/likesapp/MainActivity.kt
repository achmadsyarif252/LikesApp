...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildFace(isHappy: Boolean) {
        showEars()
        showFace()
        showEyes()
        showNose()
    ...
    private fun showEars() {
        ...
        mPaint.color =
            ResourcesCompat.getColor(resources, R.color.brown_right_hair, null)
        mCanvas.drawCircle(halfOfWidth + 300F, halfOfHeight - 100F, 100F, mPaint)
